...
var Session = /*#__PURE__*/function () {
  ...
  _createClass(Session, null, [{
    ...
    value: function registerUser(user, registerHash) {
      ...
      // register user
      return _api["default"].postData("auth/register/".concat(registerHash), user, false).then(function () {
        // signin user
    ...
    value: function signinUser(user) {
      return _api["default"].postData('auth/signin', user, false).then(function (res) {
        return Promise.resolve(res);
      })["catch"](function (err) {
        return Promise.reject(err);
      });
    ...
    value: function isValidToken(encodedToken) {
      var token = (0, _jwtDecode["default"])(encodedToken);
